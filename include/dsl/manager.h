...
#define GAME_THREAD 1
#define GAME_THREAD2 2
#define SYSTEM_THREAD 3
#define DRAWING_THREAD 4
#define POST_WORLD_THREAD 5
#define PRE_FADE_THREAD 6
#define TOTAL_THREAD_TYPES 7
